...
namespace MatrixCalc
{
    public class Help : ICommand
    {
        ...
        public string Run(string[] args)
        {
            ...
            text += $"2. Каждое число в матрице по модулю не должно превышать {Matrix.MaxAbsValue}{sep}";
            ...
            text += "-> mul <matrix1_name> <matrix2_name> [output_name] - аналогично, только считается произведение" +
                    sep;
            text += "-> muln <matrix1_name> <number> [output_name] - умножение матрицы на скаляр. " + sep;
